...
public class DetailsController {
    ...
    private void setUI() {
        ...
        */
        (activity.findViewById(R.id.btnWriteLogist)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        (activity.findViewById(R.id.btnPerform)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //TODO: Start order
            }
        ...
        (activity.findViewById(R.id.btnIssue)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //TODO: ISSUE ????
            }
